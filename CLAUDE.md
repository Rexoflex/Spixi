...
- [ ] **Next:**
  1. Batch 2: typed bubbles (payment-request 11305:6344 · payment-card · file-bubble + gap states · app-card · call-card) **+ c-unread-divider** (full-width "Unread messages" banner, computed from read flags client-side)
